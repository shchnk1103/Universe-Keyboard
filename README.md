...
✅ **雾凇拼音 + librime-lua 集成完成 + 候选栏无极滑动 + Apple HIG 合规。** 键盘支持完整 Lua 脚本功能，328 个单元测试，0 失败。候选栏移除翻页按钮，改为左右无极滑动 + 自动加载。展开面板重新设计为流式布局。Apple HIG P0-P3 合规（44pt 触摸目标、VoiceOver、Dynamic Type、语义色、Spring 动画）。
