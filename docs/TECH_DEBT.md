...
- **Related:** `.github/workflows/swift6-quality.yml`、`docs/ASSIGNMENT_POLICY.md`、KOS 2.2 advisory、TD-014。后续墙钟/定位改进见 Active [`CI-HEAVY-JOB-SPLIT-001`](assignments/ci-heavy-job-split-001.md)（拆 heavy job、去掉重复 Debug build；**不**关闭本项 A-P2-02，**不**引入路径跳过）。
