...
- **Model G2 (2026-08-11, Active / Hold):** Product authorized the minimal G2 asset-pin + device-viability gate in [`PD-TD-012-LMDG-MODEL-G2`](product-decisions/TD-012-LMDG-MODEL-G2-authorization.md). G2-A exact-byte receipt **Pass**: `420251692` bytes, SHA-256 `90d2385f65337f8b8c7b1ba5cbe874df3f2d91b462d68fa2f9fe90c57aa3bc66`; see [asset evidence](evidence/td-012-lmdg-model-g2-asset-pin-2026-08-11.md). G2-B same-device/same Extension UUID A/B is complete: model did not increase physical-footprint peak and no Keyboard Jetsam occurred, but baseline/model both produced the same post-switch `RUNNINGBOARD / 0xdead10cc` crash report. See [device evidence](evidence/td-012-lmdg-model-g2-device-ab-2026-08-11.md). Assignment Stop Condition therefore holds G3+ pending independent Architecture/Quality and Product disposition. No product installer, App Group persistence, schema/UI, default-on or other-scheme enablement is authorized.
...
| **Model G2** | **Asset pin + device viability gate** | **Active / Hold 2026-08-11:** G2-A **Pass**；same-build device A/B complete，no footprint-peak increase or Keyboard Jetsam；post-switch `0xdead10cc` triggers review Stop. No product install path. |
