...
| KOS-SUG-03 | Adopted | Publication/PR handoffs only; unknown candidate identity remains unknown. |
...
| KOS-SUG-09 | Adopted | Commit/PR handoffs only; final documentation changes require a recheck. |
