...
> **Superseded for current pin:** [PD-KOS-UPGRADE-UK-006](../../product-decisions/KOS-UPGRADE-UK-006-v0.9.0-adoption.md) adopts v0.9.0 advisory; v0.8.0 and PR #104 are historical. Text below is the historical v0.7.0 record.
...
- Disposition: Historical Adopted v0.7.0 advisory. Default-branch publication landed as PR [#99](https://github.com/shchnk1103/Universe-Keyboard/pull/99) merged 4c9f424. Current pin is v0.9.0 per [UPGRADE_STATUS](../UPGRADE_STATUS.md).
