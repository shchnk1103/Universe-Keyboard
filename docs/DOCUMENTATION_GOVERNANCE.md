...
| Environment evidence capture procedure | `docs/ENVIRONMENT_CAPTURE_PROCEDURE.md` | Reusable preparation, sequencing, tool-observation, handoff and correction procedure only; evidence fields remain in the applicable template |
