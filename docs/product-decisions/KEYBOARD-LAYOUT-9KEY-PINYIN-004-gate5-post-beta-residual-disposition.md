...
| Debt | Product stance |
|---|---|
| Full B unchanged-raw “consume 请 keep wei/fan/dao focus wo” | **Superseded for narrow device-B** by [`PD-…-GATE5-RESIDUAL-B-PATH-LEDGER-PEEL`](KEYBOARD-LAYOUT-9KEY-PINYIN-004-gate5-residual-b-path-ledger-peel.md) — Path-ledger peel of first confirmed syllable for single-CJK; still no invent-slot from 汉字数/sel/comment. **Human residual-B retest required** before product Pass claim. |
