...
- **Evidence source:** [`Release evidence and acceptance record`](evidence/release-2026-08-01-acceptance.md) + [`Build 7 artifact ledger`](evidence/release-2026-08-01-01-frozen-rc-build7-artifact-ledger-2026-08-24.md) + [`2026-08-22 metadata audit`](evidence/release-2026-08-01-05-testflight-metadata-audit-2026-08-22.md)
- **Current state:** Target date is `2026-08-26 Asia/Shanghai` (historical `2026-08-01`). Current intermediate channel is an external TestFlight candidate. Exact RC `testflight-v1.0-rc1-build7` is frozen at `244b32d`; no-distribution Xcode Cloud Build 7 produced the retained Archive/dSYMs/logs/XCResult and Store/ad hoc exports for version `1.0 (7)`, now independently Quality Reviewed with conditions. Beta description/review notes, TestFlight contacts, App Privacy publication, export declaration, age questionnaire, content rights and categories are complete by Human confirmation. Per-scheme license disclosure/acknowledgement, persistent open-source notices and their Human UI review are complete. Task 08 is Closed. Execution order is now Build 7 physical-device 04/TD-003/004/005 → separate upload authorization → internal preflight → external TestFlight Review.
...
- **Current blockers:** Frozen-RC Archive mapping has independent Quality `Pass with conditions`; online ASC authentication remains for the separately authorized upload action. iPhone 13 Pro / iOS 27 physical TD-003/004/005 evidence must use the retained Build 7 ad hoc package. iOS 18 iPad Simulator critical matrix is recorded in [`07 preflight`](evidence/release-2026-08-01-07-ios18-ipad-simulator-preflight-2026-08-21.md). Physical iPad/lower-OS device evidence remains deferred to targeted external testing and final App Store revalidation.
- **Authority boundary:** this status does not authorize upload, App Store submission, skipped-gate acceptance or manual release.
- **Next Product action:** complete the physical-device 04/TD-003/004/005 matrix. Upload, internal preflight and external Beta Review remain separate actions. R-06-08/09 stay deferred to TestFlight testers and do not skip 04 / TD-003/004/005.
