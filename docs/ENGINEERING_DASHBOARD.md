...
- **Current blockers:** Cloud artifact/dSYM retention capability is verified at pilot grade ([evidence](evidence/release-2026-08-01-01-cloud-artifact-retention-pilot-2026-08-24.md)); the exact frozen-RC Archive mapping remains open. Before freeze, confirm the selected commit/version/build and that no candidate-changing fix remains. After freeze, iPhone 13 Pro / iOS 27 physical TD-003/004/005 evidence must use the final Cloud build. iOS 18 iPad Simulator critical matrix is recorded in [`07 preflight`](evidence/release-2026-08-01-07-ios18-ipad-simulator-preflight-2026-08-21.md). Physical iPad/lower-OS device evidence remains deferred to targeted external testing and final App Store revalidation.
- **Authority boundary:** this status does not authorize upload, App Store submission, skipped-gate acceptance or manual release.
- **Next Product action:** run the pre-freeze candidate audit, choose exact commit/tag/version/build, then separately authorize the RC freeze. Final Cloud Archive/upload, internal preflight and external Beta Review remain separate actions. R-06-08/09 stay deferred to TestFlight testers and do not skip 04 / TD-003/004/005.
