...
- **First workflow:** `DIAGNOSTICS-VIEWER-LOAD-001` Active — Architecture Pass · Quality Pass with conditions；等可审查 PR 与 Human 真机复验。不 merge、不开 `required`、不 merge PR #83
