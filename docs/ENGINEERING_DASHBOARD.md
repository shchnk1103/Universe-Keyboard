...
- **Evidence source:** [`Release evidence and acceptance record`](evidence/release-2026-08-01-acceptance.md) + [`Build 7 artifact ledger`](evidence/release-2026-08-01-01-frozen-rc-build7-artifact-ledger-2026-08-24.md) + [`04 P4 device run`](evidence/release-2026-08-01-04-build7-device-run-p4-2026-08-24.md) + [`2026-08-22 metadata audit`](evidence/release-2026-08-01-05-testflight-metadata-audit-2026-08-22.md)
- **Current state:** Target date is `2026-08-26 Asia/Shanghai` (historical `2026-08-01`). Current intermediate channel is an external TestFlight candidate. Exact RC `testflight-v1.0-rc1-build7` is frozen at `244b32d`; Build 7 Archive/dSYMs/exports are independently Quality Reviewed. The exact Store IPA was separately authorized, delivered by Transporter and processed as TestFlight `1.0 (7)` / `准备提交`; groups/testers remain `0`, What to Test is blank, and no distribution or Beta Review occurred. Beta description/review notes, contacts, privacy/export/age/content-rights/category and license-disclosure work are retained as previously recorded. Task 08 is Closed.
...
- **Current blockers:** Frozen-RC upload identity and online authentication are now exercised. Build 7 P4 established the exact iPhone 13 Pro / iOS 27 cold baseline, but the current macOS/Xcode/iOS 27 Beta Time Profiler ended both authorized machine arms at about `1.3 s` with `Device disconnected` before any Human instruction; both traces are excluded and current P4 may not retry. TD-003/004/005 remain open pending a different/stable physical-device capture environment. Build-specific What to Test is also unsaved. iOS 18 iPad Simulator critical matrix is recorded in [`07 preflight`](evidence/release-2026-08-01-07-ios18-ipad-simulator-preflight-2026-08-21.md).
- **Authority boundary:** the completed upload does not authorize tester groups, distribution, Beta Review, App Store submission, skipped-gate acceptance or manual release.
- **Next Product action:** separately authorize Build 7 What to Test if desired; independently choose a different/stable physical-device capture environment for a newly authorized 04 run. Do not re-arm P4. Internal preflight, tester distribution and external Beta Review remain separate actions.
