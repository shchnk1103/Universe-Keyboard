...
- **Predecessor evidence:** Parent [`TYPO-CORRECTION-002`](typo-correction-002.md) remains the source-of-truth for the inconclusive INT-003 / QA-001 / paired-performance lane. Its detailed revalidation receipts are retained in the parent lane and are not duplicated in this recall-only staging allowlist.
...
- **Publication staging Authorization:** [`AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-BASE-RECONCILIATION-PUBLICATION-STAGING-001`](../authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-BASE-RECONCILIATION-PUBLICATION-STAGING-001.md)。
...
- **Final Architecture review:** [`bounded Architecture review`](../reviews/typo-correction-002-recall-remediation-final-architecture-review-2026-09-20.md)。
- **Final Quality review:** [`bounded Quality review`](../reviews/typo-correction-002-recall-remediation-final-quality-review-2026-09-20.md)。
...
- Parent Assignment [`typo-correction-002.md`](typo-correction-002.md)；详细 parent revalidation receipt 保留在 parent lane，不作为 recall-only publication 文件重复提交
