...
| Typing Intelligence | Excluded from V1.0 launch scope. | Do not mention it in App Store copy, screenshots or review notes. Existing implementation remains governed by `TYPING-INTELLIGENCE-001`; this scope record does not remove it. |
