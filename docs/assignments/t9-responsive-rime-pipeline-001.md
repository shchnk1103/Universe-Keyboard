...
**Lifecycle status:** `Active — R2 implemented (default-off); Arch Pass with conditions (3×P1 residual); Quality Pass with conditions (1×P1 UI bridge); keep gate off; ADR 0025 Proposed; Product Gate not claimed`  
