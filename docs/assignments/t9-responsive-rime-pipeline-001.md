...
**Lifecycle status:** `Active — ADR 0025 Accepted; POST-ACCEPT-001 hygiene + R3 inventory Completed (2026-08-06); dual-gate default-off retained; CANARY Stop/Retain; R6 / Product Gate / default-on not claimed`
