...
**2026-09-12 Platform Closed:** Human Close [`SCHEME-DELIVERY-SCHEME-PLATFORM-001`](scheme-delivery-scheme-platform-001.md). Exit Criteria met; Closed tip = docs tip on `main` (base `55ebfe9`). **not** Product Gate / TF / Release; A34-R2/TD-011 remain parallel. See [`scheme-delivery-scheme-platform-001-close-2026-09-12.md`](../evidence/scheme-delivery-scheme-platform-001-close-2026-09-12.md).

**2026-09-12 #101 merged:** PR #101 merged `543786c` (Accept tip before merge `77b62cd`). ADR Status **Accepted** now on `main`. Platform Assignment later **Closed** `2026-09-12` (separate); **no** undraft needed; **not** Product Gate / TF / Release. See [`adr-0034-accept-2026-09-12.md`](../evidence/adr-0034-accept-2026-09-12.md) · [`ADR-0034-ACCEPT-authorization.md`](../product-decisions/ADR-0034-ACCEPT-authorization.md).

**2026-09-12 Accept:** Human authorized **Accept ADR 0034** (Conditional Accept package). ADR Status **Accepted**. Freeze `main` @ `be91ca5` / merge `a6fc6f0`. leave #101 **draft**; Platform Assignment stays **Active** (no Close); **not** Product Gate / TF / Release. See [`adr-0034-accept-2026-09-12.md`](../evidence/adr-0034-accept-2026-09-12.md) · [`ADR-0034-ACCEPT-authorization.md`](../product-decisions/ADR-0034-ACCEPT-authorization.md).

**2026-09-12 Accept prep:** Human authorized **#101 Accept prep only** on draft PR #101. Freeze `main` @ `be91ca5` / merge `a6fc6f0`. **prep ≠ Accept**; ADR Status **still Proposed**; leave #101 draft; Platform Assignment stays **Active** (no Close). See [`adr-0034-accept-prep-2026-09-12.md`](../evidence/adr-0034-accept-prep-2026-09-12.md).
...
**2026-09-09 current increment:** PR #100 tip on `codex/scheme-delivery-fix` includes engineering `33b35d3`, prior docs sync `a007681` (`docs: sync Assignments after tip CI green`), and this Human merge-authorization docs update (ACTIVE_WORK link typo fix + Current Status). Human Product Owner authorized: **undraft+merge PR #100 after docs sync + hosted CI green on this tip**. `RTRD-01` (diagnostics UI for `runtimeRoutePayload`) and `RTRD-02` (ordinary Luna vs fallback `elapsed_ms`) remain **out of this PR** and are **not closed by merge** — later independent Assignments.
...
|---|---|
| Lifecycle | Active |
| Current Phase | Cross-scheme matrix engineering on PR #100 tip including docs sync **`a007681`** (engineering `33b35d3`). Matrix slices CS-01–CS-10 / CS-F* / CSF-PAIR / CS09-10-01 are on branch with independent reviews as previously recorded. Runtime-route pure contract + main-App integration + device Assignment recorded functional CS09-10-02 Pass with conditions (Ice/Wanxiang active-uninstall → Luna with Chinese candidates for controlled `ni`). Isolation checkout `/private/tmp/uk-scheme-delivery-fix` synced with origin. Human authorized undraft+merge after hosted CI green on the docs-authorization tip. DEVICE-001 **Closed**. Wanxiang P4 **Closed**（narrow A34-R1 Exit；**A34-R1 Closed（narrow）** remains Closed；still no ADR Accept）；Scheme Platform **Closed** `2026-09-12`（after #102 `a6fc6f0` / merge-record `be91ca5` / #101 `543786c` + writeback `55ebfe9`）；Human-authorized **Accept ADR 0034**（Conditional；Status **Accepted** on `main`）；**no** undraft needed；TestFlight 仍开放；**not** Product Gate |
| Material non-claims | 已推送的 reviewed candidates 均经 Human 授权；Human (2026-09-09 later) authorized undraft+merge **only after** docs sync + hosted CI green — merge does **not** mean Product Gate Passed, TestFlight/App Release, Device-attested whole-Assignment upgrade, ADR 0034 acceptance, Wanxiang P4 closure, peer-prefer fallback B, or Recovery persistence; **RTRD-01 implementation Closed via #110** / **RTRD-02 accept** under DEVICE Close — not a Product Gate; ADR 0034 Architecture Accept **review** completed 2026-09-09 (**Conditional Accept**); ADR **Accepted** (Conditional, 2026-09-12) — not Product Gate |
| Next handoff / decision | DEVICE-001 **Closed**. Architecture Accept **review completed**: [`adr-0034-architecture-accept-review-2026-09-09.md`](../reviews/adr-0034-architecture-accept-review-2026-09-09.md) — Verdict **Conditional Accept** (checklist [`adr-0034-architecture-accept-checklist-2026-09-09.md`](../reviews/adr-0034-architecture-accept-checklist-2026-09-09.md)). ADR **still Proposed**. Human (`2026-09-09`): leave #101 draft until after platform — **that later is now**. Human (`2026-09-12`): **Accept ADR 0034**（Conditional）；Status **Accepted** now on `main` via #101 `543786c`（Accept tip `77b62cd`）；A34-R8 Closed（Accept docs）；**no** undraft needed；Platform **Closed** `2026-09-12`。Product Gate / TestFlight still separate（not authorized by Platform Close）。 |
| Residuals | `RTRD-01` implementation Closed via #110 (2026-09-09 device evidence still lacks UUID/phase/elapsed values); `RTRD-02` **accept** under DEVICE Assignment; historical pre-route [CS09-10-02 failure record](../evidence/scheme-delivery-cross-scheme-cs09-cs10-device-2026-09-08.md) retained for audit; CS09-10-01 provenance/P2/P3 limits; CSF pair App Group/device transaction limits; Limited Gate historical; no Device-attested whole-Assignment close; Wanxiang P4 A34-R1 **Closed（narrow Exit）** via S6 — tracked by [`SCHEME-DELIVERY-WANXIANG-P4-CLOSURE-001`](scheme-delivery-wanxiang-p4-closure-001.md)（**Closed** `2026-09-12`；narrow Exit met；**Close ≠ ADR Accept**）；[`SCHEME-DELIVERY-SCHEME-PLATFORM-001`](scheme-delivery-scheme-platform-001.md)（**Closed** `2026-09-12`；merged via #102 `a6fc6f0`；#101 `543786c` + writeback `55ebfe9`；[close evidence](../evidence/scheme-delivery-scheme-platform-001-close-2026-09-12.md)）；Ice Lua `dofile` dynamic refs; backup/staging cleanup best-effort |
...
- [ADR 0034 Accepted (Conditional)](../architecture/decisions/0034-multi-scheme-resource-ownership.md)
