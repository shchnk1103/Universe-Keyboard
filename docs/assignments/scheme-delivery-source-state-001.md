...
| Next handoff / decision | Wanxiang upgrade-rollback Independent Quality **Pass with conditions**；Q-UR-P2-01 **Closed** ([`wanxiang-upgrade-rollback-quality`](../reviews/scheme-delivery-wanxiang-upgrade-rollback-quality-2026-09-08.md) / [`qurp201`](../reviews/scheme-delivery-wanxiang-upgrade-rollback-quality-rereview-qurp201.md)，`d1c88e3`)；PR #100 undraft/merge / TestFlight / App Release 仍单独 Human 授权；ADR 0034 保持 Proposed 直至明确接受；可选 Device-attested 复测若需升证据等级 |
