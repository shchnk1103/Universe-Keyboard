...
| Residuals | CS-09/10 not started; CS-F1/CS-F3 have Ice-target coverage only; 真机失败回滚未测（Limited Gate 历史）；无 Device-attested；Wanxiang P4 未全闭合；Ice Lua `dofile` 动态引用未闭合；backup/staging cleanup 仍 best-effort |
