...
| Next handoff / decision | P0 docs 已本地落盘 — 交 Human/Architecture 知情。**ask before push/PR**（draft #102 不自动更新）。Human ADR/#101：leave draft #101；keep #101≠#102；**no Accept ADR 0034 now**；Accept prep/cross-links later。P1 Swift / ADR Accept / Product Gate / TF / A34-R1 writeback 均须另授权。 |
