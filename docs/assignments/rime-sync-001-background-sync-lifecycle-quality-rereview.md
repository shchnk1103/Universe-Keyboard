...
The new ViewModel cancellation ordering lacks a direct injected model test.
Natural iOS BGTask scheduling, real callback/suspension timing, phone lock-screen
and Notification Center presentation, installed manifest/receipt, `TD-002`,
`TD-017`, cross-front-end evidence and Product/Release gates remain open.
