...
|---|---|---|---|
| `A-SUG-PROP-P1-01` | P1 | `DOCUMENTATION_GOVERNANCE.md:191-202` 写成“Every file under `docs/plans/` must declare exactly one lifecycle state”。当前树中至少有多份既有计划没有这五个允许状态的显式 lifecycle marker，例如 [`scheme-platform-execution-kos-2026-09-09.md:1-5`](../plans/scheme-platform-execution-kos-2026-09-09.md#L1)、[`scheme-resource-ownership-and-coexistence-plan.md:1-6`](../plans/scheme-resource-ownership-and-coexistence-plan.md#L1)、[`scheme-delivery-wanxiang-upgrade-rollback-contract-2026-09-08.md:1-8`](../plans/scheme-delivery-wanxiang-upgrade-rollback-contract-2026-09-08.md#L1) 和 [`scheme-platform-ice-reference-target-2026-09-09.md:1-6`](../plans/scheme-platform-ice-reference-target-2026-09-09.md#L1)。本 Assignment/Authorization 明确禁止迁移历史或既有 Active records（[`Assignment:58-65`](../assignments/kos-sug-proposal-handoff-001.md#L58)；[`Authorization:30-31`](../authorizations/AUTH-KOS-SUG-PROPOSAL-HANDOFF-001.md#L30)）。因此当前规则要么制造未授权的全量计划迁移，要么留下 Source-of-Truth/适用范围冲突，超出 SUG-05 的单个 pilot。 | **HOLD / `fix`。** 将规则收窄为新建或实质修改的 plan，或另建独立的历史计划迁移 Assignment；本任务不得回填、重命名或迁移现有计划。修复后重新检查规则与 pilot 的适用范围。 |
