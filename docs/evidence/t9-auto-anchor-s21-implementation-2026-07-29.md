...
- Optional three-pair counterbalanced Human matrix: **complete** (1/3
  direction PASS; residual RIME spikes). See exploratory evidence file.
- Ordinary Release remains gate-off (restored after the matrix).
