...
- **Activation / Full Access onboarding**: main-App Help presents a re-entrant activation checklist (add keyboard → Full Access → prepare RIME resources → first input). Product source: [`ONBOARDING_ACTIVATION.md`](ONBOARDING_ACTIVATION.md); semantics: [`PD-RELEASE-2026-0801-03`](product-decisions/RELEASE-2026-0801-03-activation-authorization.md); presentation packaging (soft Welcome, Help tab visibility, Settings entry, TipKit): [`PD-HELP-TIPKIT-001`](product-decisions/HELP-TIPKIT-001-authorization.md) / [`HELP-TIPKIT-001`](assignments/help-tipkit-001.md). J3 slim embed: [`PD-HELP-J3-RESOURCES-001`](product-decisions/HELP-J3-RESOURCES-001-authorization.md). Always-on **搜索** tab (far right) for settings search + J4 trial field (any content): [`PD-APP-SEARCH-001`](product-decisions/APP-SEARCH-001-authorization.md). The main App must not invent a live Extension Full Access flag; TipKit is optional packaging; no Extension tips under HELP-TIPKIT-001.
