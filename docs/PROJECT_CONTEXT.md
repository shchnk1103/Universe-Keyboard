...
- **Activation / Full Access onboarding**: main-App Guide presents a re-entrant activation checklist (add keyboard → Full Access → prepare RIME resources → first input). Product source: [`ONBOARDING_ACTIVATION.md`](ONBOARDING_ACTIVATION.md); decision: [`PD-RELEASE-2026-0801-03`](product-decisions/RELEASE-2026-0801-03-activation-authorization.md). The main App must not invent a live Extension Full Access flag; TipKit is an optional future presentation layer for the same semantics, not a second contract.
