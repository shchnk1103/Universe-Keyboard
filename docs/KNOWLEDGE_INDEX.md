...
- [TYPO-CORRECTION-002 recall remediation](assignments/typo-correction-002-recall-remediation-001.md) · [design Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-DESIGN-001.md) · [file-provenance audit](evidence/typo-correction-002-file-provenance-audit-2026-09-19.md) · [bounded design note](plans/typo-correction-002-recall-remediation-design-2026-09-19.md) · [coverage matrix](evidence/typo-correction-002-recall-coverage-matrix-2026-09-19.md) — 当前仅做 coverage-aware recall 只读设计；F-01 manifest 的独立 Assignment/Authorization 仍待另行建立
