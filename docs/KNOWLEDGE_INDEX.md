...
- T9 responsive RIME input pipeline
  ...
  dual-gate **default-off**; CANARY-001 **Stop/Retain** 2026-08-05; Product Gate
  **not** claimed; **ADR 0025 Accepted** 2026-08-06 via
  **ADR-0025-ACCEPT-001** Conditional Accept with residuals):
