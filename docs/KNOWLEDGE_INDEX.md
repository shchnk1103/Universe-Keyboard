...
- Multi-endpoint verified RIME scheme delivery (`Assignment Pending`; maintainer-linked Mainland source research complete, endpoint pilot/owners pending): [`RIME-SCHEME-DELIVERY-001`](assignments/rime-scheme-delivery-001.md) · [`source research`](evidence/rime-scheme-delivery-source-research-2026-08-25.md)
