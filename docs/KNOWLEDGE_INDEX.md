...
- KOS 2.2 advisory pin (`v0.5.0`): [`kos/UPGRADE_STATUS.md`](kos/UPGRADE_STATUS.md) · [`.kos/project.json`](../.kos/project.json) · [`KOS-UPGRADE-UK-001`](assignments/kos-upgrade-uk-001.md)
...
- Multi-endpoint verified RIME scheme delivery (`Review`; Human physical-device Wanxiang integrity failure remains unclassified and blocks Product Gate; stable-toolchain full App suite, Human Mainland matrix and endpoint acceptable-use also remain open): [`RIME-SCHEME-DELIVERY-001`](assignments/rime-scheme-delivery-001.md) · [`INTEGRITY-001`](assignments/rime-scheme-delivery-integrity-001.md) (`Active`; implementation and beta local gates complete; final Architecture `Pass`, Quality `Pass with conditions`, P0/P1=0; no commit/push/merge) · [`implementation evidence`](evidence/rime-scheme-delivery-integrity-implementation-2026-08-26.md) · [`Entry design`](assignments/rime-scheme-delivery-integrity-001-entry-design.md) · [`ADR 0032`](architecture/decisions/0032-verified-scheme-source-recovery-and-integrity-classification.md) · [`failure evidence`](evidence/rime-scheme-delivery-wanxiang-integrity-failure-2026-08-26.md)
