...
- [TYPO-CORRECTION-002 recall remediation](assignments/typo-correction-002-recall-remediation-001.md) · [design Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-DESIGN-001.md) · [conditions re-review](reviews/typo-correction-002-recall-remediation-conditions-architecture-review-2026-09-20.md) · [Product decision](product-decisions/TYPO-CORRECTION-002-RECALL-REMEDIATION-001-bounded-product-decision.md) · [Product Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-PRODUCT-DECISION-001.md) · [bounded design note](plans/typo-correction-002-recall-remediation-design-2026-09-19.md) · [coverage matrix](evidence/typo-correction-002-recall-coverage-matrix-2026-09-19.md) — Product 已有界接受方向，但只允许下一步另立 implementation-preflight Authorization；实现与 Product/Quality Gate 仍未授权；F-01 manifest 的独立 Assignment/Authorization 仍待另行建立
