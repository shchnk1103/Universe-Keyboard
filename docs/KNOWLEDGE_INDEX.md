...
- T9 responsive RIME input pipeline
  ...
  **RESPONSIVE-ALL-LAYOUTS-001** L0 universal; **RESPONSIVE-DEFAULT-ON-001**
  ...
  [`RIME-SCHEME-WANXIANG-001 Assignment`](assignments/rime-scheme-wanxiang-001.md) (`Active` — EOD handoff; next eng **TD-010**),
  ...
  multi-scheme polish debts: [`TECH_DEBT.md`](TECH_DEBT.md) **TD-009…012**,
