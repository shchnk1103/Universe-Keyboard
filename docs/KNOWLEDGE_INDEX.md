...
- T9 responsive RIME input pipeline
  ...
  **RESPONSIVE-ALL-LAYOUTS-001** L0 universal; **RESPONSIVE-DEFAULT-ON-001**
  ...
  [`PD-TD-012-OCTAGRAM-VENDOR-G1`](product-decisions/TD-012-OCTAGRAM-VENDOR-G1-authorization.md) and [`TD-012-G1 Assignment`](assignments/td-012-octagram-vendor-g1.md) (`Ready` — vendor capability only; no `.gram`),
