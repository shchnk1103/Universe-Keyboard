...
- [TYPO-CORRECTION-002 INT-003 query-density diagnosis](assignments/typo-correction-002-int003-query-density-remediation-001.md) · [operation-level run](evidence/typo-correction-002-sim-run-2026-09-25-int003-query-density-diagnostic-001.md) · [follow-up criterion decision](product-decisions/TYPO-CORRECTION-002-INT003-QUERY-DENSITY-DIAGNOSTIC-CRITERION-001.md) — 359 real query pairs across 12 operations; 180 ms no longer a hard pass bar for this follow-up diagnosis; original rapid-window attribution and wider Product residual remain open; parent stays Active
