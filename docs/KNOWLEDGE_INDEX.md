...
- [TYPO-CORRECTION-002 residual reconciliation](assignments/typo-correction-002-residual-reconciliation-001.md) · [Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RESIDUAL-RECONCILIATION-001.md) · [receipt](evidence/typo-correction-002-residual-reconciliation-2026-09-19.md) — 已完成既有 AX/test-only harness 与 child KOS 记录对账；下一步从 clean worktree 开启新的 recall-remediation lane
- [TYPO-CORRECTION-002 recall remediation](assignments/typo-correction-002-recall-remediation-001.md) · [design Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-DESIGN-001.md) · [Architecture Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-ARCHITECTURE-001.md) · [conditions Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-CONDITIONS-001.md) · [conditions re-review Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-CONDITIONS-ARCHITECTURE-001.md) · [Architecture review](reviews/typo-correction-002-recall-remediation-architecture-review-2026-09-20.md) · [file-provenance audit](evidence/typo-correction-002-file-provenance-audit-2026-09-19.md) · [bounded design note](plans/typo-correction-002-recall-remediation-design-2026-09-19.md) · [coverage matrix](evidence/typo-correction-002-recall-coverage-matrix-2026-09-19.md) — B1–B3 已完成 docs-only 对账，等待 exact-tip 独立 Architecture re-review；实现与 Product/Quality 结论仍未授权；F-01 manifest 的独立 Assignment/Authorization 仍待另行建立
