...
- T9 responsive RIME input pipeline
  ...
  **RESPONSIVE-ALL-LAYOUTS-001** L0 universal; **RESPONSIVE-DEFAULT-ON-001**
  ...
  [`PD-RIME-SCHEME-WANXIANG-001`](product-decisions/RIME-SCHEME-WANXIANG-001-authorization.md) (**Proposed** — 万象全拼 V1 + **layout-bound scheme picker**),
  [`RIME-SCHEME-WANXIANG-001 Assignment`](assignments/rime-scheme-wanxiang-001.md) (`Assignment Pending`),
  [`ADR 0026`](architecture/decisions/0026-layout-bound-rime-scheme-selection.md) (**Proposed draft** — layout-bound RIME scheme selection; amends 0018; not Accepted),
