...
- Multi-endpoint verified RIME scheme delivery (`Review`; PR #83 merged current `main`, ADR 0032; Human Mainland retry and Product Gate remain open): [`RIME-SCHEME-DELIVERY-001`](assignments/rime-scheme-delivery-001.md) · [`INTEGRITY-001`](assignments/rime-scheme-delivery-integrity-001.md) · [`SCHEME-DELIVERY-JOURNAL-001`](assignments/scheme-delivery-journal-001.md) (`Active`; TD-015) · [`ADR 0032`](architecture/decisions/0032-verified-scheme-source-recovery-and-integrity-classification.md) · [`failure evidence`](evidence/rime-scheme-delivery-wanxiang-integrity-failure-2026-08-26.md)
