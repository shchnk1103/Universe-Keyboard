...
- [TYPO-CORRECTION-002 INT-003 query-cost measurement](assignments/typo-correction-002-int003-query-cost-measurement-001.md) · [P0 measurement plan](plans/typo-correction-002-int003-query-cost-measurement-001.md) — Active planning Assignment, docs-only AUTH Consumed; instrumentation, device capture, numeric budget and Gate await separate authority
