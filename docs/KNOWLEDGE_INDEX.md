...
- [TYPO-CORRECTION-002 recall remediation](assignments/typo-correction-002-recall-remediation-001.md) · [implementation-preflight child](assignments/typo-correction-002-recall-remediation-implementation-preflight-001.md) · [preflight Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-IMPLEMENTATION-PREFLIGHT-001.md) · [conditions re-review](reviews/typo-correction-002-recall-remediation-conditions-architecture-review-2026-09-20.md) · [Product decision](product-decisions/TYPO-CORRECTION-002-RECALL-REMEDIATION-001-bounded-product-decision.md) · [Product Authorization](authorizations/AUTH-TYPO-CORRECTION-002-RECALL-REMEDIATION-PRODUCT-DECISION-001.md) · [bounded design note](plans/typo-correction-002-recall-remediation-design-2026-09-19.md) · [coverage matrix](evidence/typo-correction-002-recall-coverage-matrix-2026-09-19.md) — implementation-preflight child 已 Ready、Authorization active；仅允许纯 KeyboardCore/preflight 与契约测试；生产接线、RIME、设备 Run、性能和 Gate 仍未授权；F-01 manifest 的独立 Assignment/Authorization 仍待另行建立
