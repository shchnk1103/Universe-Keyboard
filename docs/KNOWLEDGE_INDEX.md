...
- Knowledge OS 2.1 operational maturity **design only** (2.0 still binding): [`PD-KOS-2.1-OPS-001`](product-decisions/KOS-2.1-OPS-001-authorization.md), [`Assignment`](assignments/kos-2.1-ops-001.md), [`design draft`](kos/kos-2.1-ops-design-draft.md), [`Architecture review`](assignments/kos-2.1-ops-001-architecture-review.md) (Pass with conditions; Product Review pending)
