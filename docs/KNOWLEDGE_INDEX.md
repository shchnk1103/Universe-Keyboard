...
- T9 responsive RIME input pipeline
  ...
  **RESPONSIVE-ALL-LAYOUTS-001** L0 universal; **RESPONSIVE-DEFAULT-ON-001**
  ...
  [`PD-RIME-SCHEME-WANXIANG-001`](product-decisions/RIME-SCHEME-WANXIANG-001-authorization.md) (**Active** — 万象全拼 catalog pin `base.zip` / `wanxiang`; layout-bound picker shipped),
  [`RIME-SCHEME-WANXIANG-001 Assignment`](assignments/rime-scheme-wanxiang-001.md) (`Active`),
