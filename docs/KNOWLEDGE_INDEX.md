...
- Multi-endpoint verified RIME scheme delivery (`Assignment Pending`; bounded current-Mac pilot: exact NJU 雾凇 match, CNB 万象 same-tag mismatch; implementation owners and Mainland matrix pending): [`RIME-SCHEME-DELIVERY-001`](assignments/rime-scheme-delivery-001.md) · [`endpoint pilot`](evidence/rime-scheme-delivery-endpoint-pilot-2026-08-25.md) · [`source research`](evidence/rime-scheme-delivery-source-research-2026-08-25.md)
