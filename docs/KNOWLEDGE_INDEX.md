...
- Built-in offline Luna quality (F-02, Active；Human Product Gate Passed for merge of PR #93): [`RIME-BUILTIN-LUNA-QUALITY-001`](assignments/rime-builtin-luna-quality-001.md) · ADR [`0033`](architecture/decisions/0033-main-app-owned-offline-rime-resource-closure.md) · [`Gate`](product-decisions/RIME-BUILTIN-LUNA-QUALITY-001-product-gate.md)
