...
- T9 responsive RIME input pipeline
  ...
  **not** claimed; auto-anchor Hold/harvest):
  ...
  [`CANARY-001 production-shaped canary Active; implementation only, evidence capture not activated`](assignments/t9-responsive-pipeline-001-production-shaped-canary-001.md),
