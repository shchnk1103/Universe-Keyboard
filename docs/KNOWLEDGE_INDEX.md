...
- T9 responsive RIME input pipeline
  ...
  **RESPONSIVE-ALL-LAYOUTS-001** L0 universal; **RESPONSIVE-DEFAULT-ON-001**
  ...
  [`PD-RIME-SCHEME-WANXIANG-001`](product-decisions/RIME-SCHEME-WANXIANG-001-authorization.md) (**Active** — V1 path Human-verified 2026-08-07; formal close optional),
  [`RIME-SCHEME-WANXIANG-001 Assignment`](assignments/rime-scheme-wanxiang-001.md) (`Active` — EOD 2026-08-08; next eng **TD-012** or optional TD-011 B–D),
  ...
  multi-scheme debts: [`TECH_DEBT.md`](TECH_DEBT.md) **TD-009/010 repaid**; **TD-011 A done** / B–D open; **TD-012 open**,
