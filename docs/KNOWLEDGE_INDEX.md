...
- Nine-key complete local Path catalog + atomic sync (`Active — H5 residual Product-accepted; commit/push authorized by PD post-β residual; full B/Human Gate not closed`): [`assignments/keyboard-layout-9key-pinyin-004.md`](assignments/keyboard-layout-9key-pinyin-004.md), Product Decision [`PD-...-004`](product-decisions/KEYBOARD-LAYOUT-9KEY-PINYIN-004-authorization.md), Gate5 path [`PD-…-004-GATE5-PATH`](product-decisions/KEYBOARD-LAYOUT-9KEY-PINYIN-004-gate5-path-decision.md), post-β residual [`PD-…-GATE5-POST-BETA-RESIDUAL`](product-decisions/KEYBOARD-LAYOUT-9KEY-PINYIN-004-gate5-post-beta-residual-disposition.md), ADR [`0023`](architecture/decisions/0023-t9-complete-local-path-catalog-and-atomic-presentation.md), catalog provenance [`t9-pinyin-syllable-catalog.md`](architecture/t9-pinyin-syllable-catalog.md), plan [`004 plan`](plans/keyboard-layout-9key-pinyin-004-complete-path-catalog-and-atomic-sync-plan.md), Gate5 plan [`gate5 plan`](plans/keyboard-layout-9key-pinyin-004-gate5-path-partial-delete-fix-plan.md), evidence [`004 evidence`](assignments/keyboard-layout-9key-pinyin-004-implementation-evidence.md), Gate5 evidence [`gate5 evidence`](assignments/keyboard-layout-9key-pinyin-004-gate5-remediation-evidence.md) §21–§27, post-β handoff [`post-β handoff`](assignments/keyboard-layout-9key-pinyin-004-gate5-post-beta-human-residual-review-handoff.md), post-β independent review [`post-β review`](assignments/keyboard-layout-9key-pinyin-004-gate5-post-beta-human-residual-independent-review.md), Phase 0.5 review [`phase05 review`](assignments/keyboard-layout-9key-pinyin-004-gate5-phase05-independent-review.md), Gate entry [`004 gate entry`](assignments/keyboard-layout-9key-pinyin-004-gate-entry-status.md)
