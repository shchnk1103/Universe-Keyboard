...
- KOS 2.2 advisory pin (`v0.5.0`; `v0.6.0` Deferred pending PR #92 Gate): [`kos/UPGRADE_STATUS.md`](kos/UPGRADE_STATUS.md) · [`.kos/project.json`](../.kos/project.json) · [`KOS-UPGRADE-UK-001`](assignments/kos-upgrade-uk-001.md) · [`KOS-UPGRADE-UK-002`](assignments/kos-upgrade-uk-002.md)
