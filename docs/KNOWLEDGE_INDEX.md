...
- Built-in offline Luna quality (F-02, Active；PR #93 待 Human Product Gate): [`RIME-BUILTIN-LUNA-QUALITY-001`](assignments/rime-builtin-luna-quality-001.md) · ADR [`0033`](architecture/decisions/0033-main-app-owned-offline-rime-resource-closure.md) · [`proposed Gate`](product-decisions/RIME-BUILTIN-LUNA-QUALITY-001-product-gate.md)
