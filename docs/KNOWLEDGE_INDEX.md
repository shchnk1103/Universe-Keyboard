...
- Multi-endpoint verified RIME scheme delivery (`Assignment Pending`; Product accepted no-new-server source variants: exact NJU 雾凇 match, GitHub/CNB 万象 ordinary staged runtime equivalent while CNB-only Pure files stay excluded; implementation owners and Mainland matrix pending): [`RIME-SCHEME-DELIVERY-001`](assignments/rime-scheme-delivery-001.md) · [`source-variant PD`](product-decisions/RIME-SCHEME-DELIVERY-001-source-variants.md) · [`endpoint pilot`](evidence/rime-scheme-delivery-endpoint-pilot-2026-08-25.md) · [`source research`](evidence/rime-scheme-delivery-source-research-2026-08-25.md)
