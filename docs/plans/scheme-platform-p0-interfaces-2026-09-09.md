...
- **Installed Capability Discovery / layout-picker** (and Lua/OpenCC product-surface honesty) — **Human deferred** later Assignment (not yet drafted); separate Human Active; **not** P1 UI. **Layout-page A/B UX + uninstall layout-fallback + Luna presence + readiness greying Decided** — [`scheme-platform-discovery-layout-ux-2026-09-09.md`](scheme-platform-discovery-layout-ux-2026-09-09.md); P1 may add readiness **query** seams if needed  
