...
**Assignment carrier (Ready):** [`SCHEME-DELIVERY-SCHEME-PLATFORM-001`](../assignments/scheme-delivery-scheme-platform-001.md)  
**Related Active:** [`SCHEME-DELIVERY-WANXIANG-P4-CLOSURE-001`](../assignments/scheme-delivery-wanxiang-p4-closure-001.md) (A34-R1 narrow closure — do **not** expand into this platform mega-refactor)
...
1. **Ready → Active** on [`SCHEME-DELIVERY-SCHEME-PLATFORM-001`](../assignments/scheme-delivery-scheme-platform-001.md) before any P0 matrix expansion that claims execution, and before any P1 Swift.  
