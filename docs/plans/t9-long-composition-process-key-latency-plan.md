...
| Field | Value |
|---|---|
| Status | **Active — Hold/harvest after S2.3 direction FAIL; default-off S2.1–S2.3 retained; no next knife authorized** |
| Created | 2026-07-24 |
...
| S2.3 — Earlier first-anchor | Lower attempt-1 digit floor under new default-off gate; retain two-syllable first-anchor; attack pre-first-anchor e16-class | **Implemented default-off; Human B3→B3e mechanism PASS / direction FAIL** | **Hold/harvest** — retain stack; no next knife without later PD; Release/Product Gate separate |
