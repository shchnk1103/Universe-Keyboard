...
Status snapshot (existing rows): `2026-09-08 Asia/Shanghai` — `SCHEME-DELIVERY-SOURCE-STATE-001` CS-03–CS-08 plus CS-F1/CS-F3 landed locally; Luna-only active-uninstall policy supersedes peer-prefer B; independent review pending. Limited P4 Gate remains historical. 产品 Active Work 为 `6/10`。KOS-UPGRADE-UK-003 Closed 仍以 Assignment 为准。
...
| 6 | SCHEME-DELIVERY-SOURCE-STATE-001 | Active | Cross-scheme **CS-01/02 done**; **CS-03–CS-08 + CS-F1/F3 landed locally** (repeat no-op, inactive peer retain, active Luna-only fallback, named failure injections; not pushed); independent review pending. Peer-prefer B is superseded; CS-09/10 remain separate. PR #100 draft; no undraft/merge/TestFlight/ADR Accept; checkout `/private/tmp/uk-scheme-delivery-fix` | [`assignment`](assignments/scheme-delivery-source-state-001.md) · [`matrix contract`](plans/scheme-delivery-cross-scheme-matrix-contract-2026-09-08.md) · [`p4-remaining`](plans/scheme-delivery-p4-remaining-matrix-2026-09-08.md) · [`Limited PG`](evidence/scheme-delivery-source-state-001-p4-product-gate-2026-09-08.md) · [`ADR 0034`](architecture/decisions/0034-multi-scheme-resource-ownership.md) · [PR #100](https://github.com/shchnk1103/Universe-Keyboard/pull/100) |
