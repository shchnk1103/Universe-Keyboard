...
| 6 | SCHEME-DELIVERY-SOURCE-STATE-001 | Active | 共存/资源归属规划切片完成；Proposed ADR 0034。P0 复现未授权。PR #100 原工程片仍待 Human 真机复测/merge | [`assignment`](assignments/scheme-delivery-source-state-001.md) · [`plan`](plans/scheme-resource-ownership-and-coexistence-plan.md) · [`ADR 0034`](architecture/decisions/0034-multi-scheme-resource-ownership.md) · [PR #100](https://github.com/shchnk1103/Universe-Keyboard/pull/100) |
