...
| 4 | TD-016-CI-TIERING-001 | Active | 实施 fail-closed 分类、轻量门禁与稳定 final Gate；之后独立 Architecture/Quality review 和 Human PR 决策 | [`assignment`](assignments/td-016-ci-tiering-001.md) · [`ADR 0031`](architecture/decisions/0031-fail-closed-ci-change-classification.md) |
...
| P2 | **[TD-016](TECH_DEBT.md#td-016-ci-变更分级与文档提交快速门禁) CI 变更分级** | Assignment 已 Active；实现与本地验证完成，等待托管运行及独立 Architecture/Quality review；未改 required checks |
