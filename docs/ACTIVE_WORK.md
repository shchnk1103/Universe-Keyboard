...
| 6 | SCHEME-DELIVERY-SOURCE-STATE-001 | Active | 雾凇固定制品、源探测分类和跨方案失败提示修复；验证与独立复审进行中，真机/合并未授权 | [Assignment](assignments/scheme-delivery-source-state-001.md) · [Evidence](evidence/scheme-delivery-source-state-001.md) |
