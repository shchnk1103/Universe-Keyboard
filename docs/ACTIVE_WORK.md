...
| 8 | SCHEME-DELIVERY-SCHEME-PLATFORM-001 | **Active** | **P2 landed locally**（Wanxiang → `privatePreset` / `wanxiang_preset`；plan2/post2；exactHash kept；P1 IQ still recorded）— keep Active；**ask before push**；next after push = CI / product regression note。Human ADR/#101：leave draft #101；keep #101≠#102；**no Accept ADR 0034 now**。Wanxiang P4 **Paused**（A34-R1 open）。无 TF；无 Wanxiang nine-key；无 Discovery UI；无 Assignment Close；无 undraft/merge #102。 | [`assignment`](assignments/scheme-delivery-scheme-platform-001.md) · [`P1 summary`](plans/scheme-platform-p1-summary-2026-09-12.md) · [`P1 IQ`](reviews/scheme-delivery-scheme-platform-001-p1-quality-review.md) · [`P1 extract plan`](plans/scheme-platform-p1-extract-plan-2026-09-10.md) · [`P0 interfaces`](plans/scheme-platform-p0-interfaces-2026-09-09.md) · [`P0 matrix`](evidence/scheme-platform-p0-ice-wanxiang-matrix-2026-09-09.md) · [`target`](plans/scheme-platform-ice-reference-target-2026-09-09.md) · [`KOS runbook`](plans/scheme-platform-execution-kos-2026-09-09.md) · [`Paused Wanxiang P4`](assignments/scheme-delivery-wanxiang-p4-closure-001.md) · [PR #102](https://github.com/shchnk1103/Universe-Keyboard/pull/102) |
