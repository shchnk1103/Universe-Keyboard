...
Last synced: `2026-09-03 Asia/Shanghai` — KOS-UPGRADE-UK-003 Adopt `v0.6.0` advisory 进行中。核心 Active Work 为 `6/10`。
...
| 6 | KOS-UPGRADE-UK-003 | Active | Adopt `v0.6.0` advisory pin；`required` 未授权。Human Product Gate Passed，待合入 | [`assignment`](assignments/kos-upgrade-uk-003.md) · [`PD`](product-decisions/KOS-UPGRADE-UK-003-authorization.md) · [`Gate`](product-decisions/KOS-UPGRADE-UK-003-product-gate.md) |
