...
| 6 | SCHEME-DELIVERY-SOURCE-STATE-001 | Active | P0：Ice 覆盖 `default.yaml` 后 builtin redeploy 为 `byteCountMismatch`。P1 未授权。PR #100 仍待 Human 真机复测/merge | [`assignment`](assignments/scheme-delivery-source-state-001.md) · [`plan`](plans/scheme-resource-ownership-and-coexistence-plan.md) · [`P0 evidence`](evidence/scheme-delivery-source-state-001-p0-2026-09-07.md) · [`ADR 0034`](architecture/decisions/0034-multi-scheme-resource-ownership.md) · [PR #100](https://github.com/shchnk1103/Universe-Keyboard/pull/100) |
