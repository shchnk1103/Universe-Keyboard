...
| 8 | GIT-BRANCH-ARCHIVE-HYGIENE-001 | **Active** | Group A tag-then-delete authorized. Unique commits stay on archive tags, not `main`. No Group B / #101 / #102 / merge. | [`assignment`](assignments/git-branch-archive-hygiene-001.md) · [`plan`](plans/parked-branch-archive-hygiene-2026-09-11.md) · [`PD`](product-decisions/GIT-BRANCH-ARCHIVE-HYGIENE-001-authorization.md) |
