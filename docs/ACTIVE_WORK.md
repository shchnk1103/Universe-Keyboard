...
Current update: `2026-09-12 Asia/Shanghai` — Human 真机目视 Pass [`RIME-SCHEME-DETAIL-PROVENANCE-SHEET-001`](assignments/rime-scheme-detail-provenance-sheet-001.md)；授权隔离功能分支 commit + push + PR。本表加为第 8 行。无 merge；不并入 #102。
...
| 8 | RIME-SCHEME-DETAIL-PROVENANCE-SHEET-001 | **Active** | Human 真机目视 Pass。隔离分支 commit + push + PR；无 merge；不并入 Scheme Platform #102。 | [`assignment`](assignments/rime-scheme-detail-provenance-sheet-001.md) |
