...
| 4 | TD-016-CI-TIERING-001 | Active | 托管 full-path 已绿；补 docs-only 托管 fixture，并完成独立 Architecture/Quality review 后交回 Human | [`assignment`](assignments/td-016-ci-tiering-001.md) · [`evidence`](evidence/td-016-ci-tiering-001-implementation-2026-08-28.md) |
...
| P2 | **[TD-016](TECH_DEBT.md#td-016-ci-变更分级与文档提交快速门禁) CI 变更分级** | 托管 full-path 已绿；等待 docs-only 托管 fixture 与独立 Architecture/Quality review；未改 required checks |
