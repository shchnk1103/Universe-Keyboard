...
Status snapshot (existing rows): `2026-09-03 Asia/Shanghai` — KOS-UPGRADE-UK-003 Closed（PR #96 merged `41c0dc5`，Adopted `v0.6.0` advisory）。原有产品 Active Work 为 `5/10`；本次治理准备另列，总计 `6/10`。
...
| Work Item | Lifecycle | Next | Assignment |
|---|---|---|---|
| KOS-ASTRA-UPGRADE-001 | Active | 两仓库候选验证与独立评审 | [Assignment](assignments/kos-astra-upgrade-001.md) |
