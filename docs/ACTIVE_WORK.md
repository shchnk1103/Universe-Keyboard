...
| 4 | TYPO-CORRECTION-002-F01-REMEDIATION-001 | Active | RIME identity sentinel fail-closed remediation；executor evidence 已记录；等待独立 Architecture/Quality review；不含 commit/push/PR，parent 仍 Active | [`assignment`](assignments/typo-correction-002-f01-remediation-001.md) · [`authorization`](authorizations/AUTH-TYPO-CORRECTION-002-F01-REMEDIATION-001.md) · [`executor evidence`](evidence/typo-correction-002-f01-remediation-001-executor-evidence.md) |
