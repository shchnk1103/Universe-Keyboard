...
| 2 | RIME-BUILTIN-LUNA-QUALITY-001 | Active | PR #93 已合。首次自动部署 + fuzzy 默认关在 `fix/f02-first-launch-autodeploy-fuzzy-off`。待 PR 与 Human 真机删装。无 Exit / TestFlight / Release | [`assignment`](assignments/rime-builtin-luna-quality-001.md) · [`Gate`](product-decisions/RIME-BUILTIN-LUNA-QUALITY-001-product-gate.md) · [`handoff`](evidence/rime-builtin-luna-quality-f02-device-handoff-2026-08-31.md) |
