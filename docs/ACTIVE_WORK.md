...
Last synced: `2026-09-03 Asia/Shanghai` — KOS-UPGRADE-UK-003 Closed（PR #96 merged `41c0dc5`，Adopted `v0.6.0` advisory）。核心 Active Work 为 `5/10`。
...
| 2 | RIME-BUILTIN-LUNA-QUALITY-001 | Active | PR [#93](https://github.com/shchnk1103/Universe-Keyboard/pull/93) merged `ec6c277`。Human Product Gate 仅覆盖本片 merge；残差 `accept`。无 Exit / TestFlight / Release | [`assignment`](assignments/rime-builtin-luna-quality-001.md) · [`Gate`](product-decisions/RIME-BUILTIN-LUNA-QUALITY-001-product-gate.md) · [`AUTH`](authorizations/AUTH-RIME-BUILTIN-LUNA-QUALITY-001-MERGE.md) · [`handoff`](evidence/rime-builtin-luna-quality-f02-device-handoff-2026-08-31.md) |
...
|---|---|---|
| KOS-UPGRADE-UK-003 | `Closed`；PR [#96](https://github.com/shchnk1103/Universe-Keyboard/pull/96) merged `41c0dc5`；Adopted `v0.6.0` advisory；`required` 未授权 | [`assignment`](assignments/kos-upgrade-uk-003.md) · [`Gate`](product-decisions/KOS-UPGRADE-UK-003-product-gate.md) · [`record`](kos/upgrade-records/KOS-UPGRADE-UK-003-v0.6.0.md) |
| KOS-UPGRADE-UK-002 | `Closed`；PR [#92](https://github.com/shchnk1103/Universe-Keyboard/pull/92) merged `cb49e62`；历史 Deferred-check；Adopted pin 已被 UK-003 取代 | [`assignment`](assignments/kos-upgrade-uk-002.md) · [`Gate`](product-decisions/KOS-UPGRADE-UK-002-product-gate.md) · [`record`](kos/upgrade-records/KOS-UPGRADE-UK-002-v0.6.0.md) |
