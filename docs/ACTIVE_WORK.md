...
Last synced: `2026-08-30 Asia/Shanghai` — F-02 reviewer conditions 已在 `85d0249` 收敛并等待最终独立复审；聚焦门禁、完整 RimeBridge/KeyboardCore 与 Debug/Release 构建通过，App aggregate 因模拟器 App Group entitlement 在多个既有部署测试中失败，未伪报为绿；真机与下游 Gate 不前移。核心 Active Work 为 `4/10`。
...
| 2 | RIME-BUILTIN-LUNA-QUALITY-001 | Active | P1；`85d0249` 已收敛 bundle-extra、overlay rollback、完整首屏 order 与 Stroke session isolation 条件；聚焦验证、完整 RimeBridge/KeyboardCore 和双构建通过，App aggregate 被模拟器 App Group entitlement 阻断；等待最终独立 Architecture/Quality 复审 | [`assignment`](assignments/rime-builtin-luna-quality-001.md) · [`evidence`](evidence/rime-builtin-luna-quality-f02-implementation-2026-08-30.md) · [`Architecture`](assignments/rime-builtin-luna-quality-001-architecture-review.md#post-implementation-review--09659a7--2026-08-30) · [`Quality`](assignments/rime-builtin-luna-quality-001-quality-review.md#post-implementation-review--09659a7--2026-08-30) |
