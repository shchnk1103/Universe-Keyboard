...
| 8 | GIT-BRANCH-ARCHIVE-HYGIENE-002 | **Active** | Group B annotated tags only; do not delete local branches. Predecessor 001 Closed after #118. No #101/#102 / merge of this docs PR. | [`assignment`](assignments/git-branch-archive-hygiene-002.md) · [`plan`](plans/parked-branch-archive-hygiene-2026-09-11.md) · [`PD`](product-decisions/GIT-BRANCH-ARCHIVE-HYGIENE-002-authorization.md) · Closed [`001`](assignments/git-branch-archive-hygiene-001.md) |
