...
| 8 | GIT-BRANCH-ARCHIVE-HYGIENE-003 | **Active** | Keep all three Group B local names. Architecture/Quality Pass 0/0/0/0. Next: docs-only PR (merge not authorized). No delete. | [`assignment`](assignments/git-branch-archive-hygiene-003.md) · [`evidence`](evidence/git-branch-archive-hygiene-003-keep-2026-09-11.md) · [`Architecture`](reviews/GIT-BRANCH-ARCHIVE-HYGIENE-003-architecture-review.md) · [`Quality`](reviews/GIT-BRANCH-ARCHIVE-HYGIENE-003-quality-review.md) |
