...
Last synced: `2026-08-27 Asia/Shanghai` — KOS Agent Kit `v0.5.0` advisory 已钉住；诊断查看 Assignment 为 `Ready`。Active Work `5/10`。
...
| 4 | KOS-UPGRADE-UK-001 | Active | Kit `v0.5.0` advisory pin；未授权 `required` | [`assignment`](assignments/kos-upgrade-uk-001.md) · [`PD`](product-decisions/KOS-UPGRADE-UK-001-authorization.md) · [`status`](kos/UPGRADE_STATUS.md) |
| 5 | DIAGNOSTICS-VIEWER-LOAD-001 | Ready | 加载态/空态与有界读取；等待授权实现 | [`assignment`](assignments/diagnostics-viewer-load-001.md) · [`PD`](product-decisions/DIAGNOSTICS-VIEWER-LOAD-001-authorization.md) |
