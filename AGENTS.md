...
7. KOS 2.2 目前为 **advisory**，Adopted pin `v0.7.0`：入口是 [`docs/kos/UPGRADE_STATUS.md`](docs/kos/UPGRADE_STATUS.md) 与 `.kos/project.json`。校验绿不是 Product / merge / Release。未授权 `required`。
