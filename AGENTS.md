...
7. KOS 2.2 目前为 **advisory**，Adopted pin `v0.8.0`：E-01、A-01/B-01、P-01、D-01 仅供新记录显式 opt-in；入口是 [`docs/kos/UPGRADE_STATUS.md`](docs/kos/UPGRADE_STATUS.md) 与 `.kos/project.json`。校验绿不是 Product / merge / Release。未授权 `required`。
